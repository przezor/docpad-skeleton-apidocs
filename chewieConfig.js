const config = {
  ...
  registry: {
    ...
    path: process.env.REGISTRY_PATH || 'git@github.com:przezor/docpad-skeleton-apidocs-sampledata.git',
  ...
  generationResult: {
    srcLocation: 'git@github.com:przezor/chewie-sample-result.git',
    branch: process.env.docuBranch || 'master',

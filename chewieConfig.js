const config = {
  ...
  registry: {
    ...
    path: process.env.REGISTRY_PATH || 'https://53124a73fa081d5fef9b19ba38df74c81adc0132:@github.com/przezor/docpad-skeleton-apidocs-sampledata.git',
  ...
  generationResult: {
    srcLocation: 'https://53124a73fa081d5fef9b19ba38df74c81adc0132:@github.com/przezor/chewie-sample-result.git',
    branch: process.env.docuBranch || 'master',

const config = {
  ...
  registry: {
    ...
    path: process.env.REGISTRY_PATH || 'https://przezor:$GH_TOKEN@github.com/przezor/docpad-skeleton-apidocs-sampledata.git',
  ...
  generationResult: {
    srcLocation: 'https://przezor:$GH_TOKEN@github.com/przezor/chewie-sample-result.git',
    branch: process.env.docuBranch || 'master',

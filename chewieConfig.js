const config = {
  ...
  registry: {
    ...
    path: process.env.REGISTRY_PATH || 'https://przezor:960e294fb72768376785d586311dec1ab3e079ac@github.com/przezor/docpad-skeleton-apidocs-sampledata.git',
  ...
  generationResult: {
    srcLocation: 'https://przezor:960e294fb72768376785d586311dec1ab3e079ac@github.com/przezor/chewie-sample-result.git',
    branch: process.env.docuBranch || 'master',
